...
class AjustarStockController extends AbstractController
{
  ...
  public function ajuste(Request $request, StockRepository $repoStock, ActualizarStockService $actualizarStock): JsonResponse
  {
    ...
    try {
      ...
      if ($form->isSubmitted() && $form->isValid()) {
        ...
        ($actualizarStock)($stock, 3, $request->get('cantidad')); //3 es ajuste

        return new JsonResponse(['message' => 'Ajuste Exitoso'], 201);
      } else {
